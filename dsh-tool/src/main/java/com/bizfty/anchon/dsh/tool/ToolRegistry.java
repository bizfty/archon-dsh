...
public class ToolRegistry {
    ...
    public List<com.bizfty.anchon.dsh.core.prompt.ToolRef> toToolRefs(com.bizfty.anchon.dsh.util.JsonUtils jsonUtils) {
        return tools.values().stream()
                .map(t -> new com.bizfty.anchon.dsh.core.prompt.ToolRef(
                        t.name(),
