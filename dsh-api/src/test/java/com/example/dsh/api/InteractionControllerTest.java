...
import com.example.dsh.interaction.InMemoryApprovalProvider;
import com.example.dsh.interaction.InMemoryUserQuestionProvider;
...
class InteractionControllerTest {
    ...
    void approvalLifecycleCompletesPendingRequest() {
        ...
        CompletableFuture<String> decision = CompletableFuture.supplyAsync(() -> {
            var d = provider.request(new com.example.dsh.interaction.ApprovalRequest(
    ...
    void questionLifecycleCompletesPendingRequest() {
        ...
        CompletableFuture<String> answer = CompletableFuture.supplyAsync(() -> {
            var a = provider.ask(new com.example.dsh.interaction.UserQuestion(
