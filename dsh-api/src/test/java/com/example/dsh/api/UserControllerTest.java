...
class UserControllerTest {
    ...
    void registerLoginMeFlow() {
        ...
        com.example.dsh.user.UserProfile.UserView view = (com.example.dsh.user.UserProfile.UserView) me.getBody();
    ...
    void updateLlmConfigReflects() {
        ...
        com.example.dsh.user.UserProfile.UserView view =
                (com.example.dsh.user.UserProfile.UserView) updated.getBody();
