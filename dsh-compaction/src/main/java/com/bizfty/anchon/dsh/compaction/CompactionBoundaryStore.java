...
public class CompactionBoundaryStore {
    ...
    public int read(SessionId sessionId) {
        return storage.get(com.bizfty.anchon.dsh.core.model.SessionSettings.namespace(sessionId),
                        com.bizfty.anchon.dsh.core.model.SessionSettings.KEY_COMPACTION_BOUNDARY)
    ...
    public void write(SessionId sessionId, int shadowedHeadCount) {
        ...
        storage.put(com.bizfty.anchon.dsh.core.model.SessionSettings.namespace(sessionId),
                com.bizfty.anchon.dsh.core.model.SessionSettings.KEY_COMPACTION_BOUNDARY,
                String.valueOf(shadowedHeadCount));
    }

    /** 会话结束时清除边界（可选）。 */
    public void clear(SessionId sessionId) {
        storage.delete(com.bizfty.anchon.dsh.core.model.SessionSettings.namespace(sessionId),
                com.bizfty.anchon.dsh.core.model.SessionSettings.KEY_COMPACTION_BOUNDARY);
    }
}
